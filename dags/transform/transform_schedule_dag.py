...
with DAG(
    ...
    trigger_load_schedule_task = TriggerDagRunOperator(
        task_id='load_schedule',
        trigger_dag_id='load_schedule_dag',
    )

    start_log >> transform_schedule_task >> end_log >> trigger_load_schedule_task